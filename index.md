...
venue: "Quarterly SI Data Carpentry: Winter 2020 Edition"        # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "Feb 12-13, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2020-02-12      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2020-02-13        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Amanda Devine", "Jennifer Giaccai", "Jen Hammock"]    # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Alicia Hodson", "Matthew Kweskin"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["hammockj@si.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.carpentries.org/2020-02-12-castle            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 91642271501         # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
REGISTRATION OPENS JANUARY 29 at 10AM
